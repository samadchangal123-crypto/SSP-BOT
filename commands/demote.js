...
await sock.sendMessage(chatId, { 
                text: `╭━━━━━━━━━━━━━━━━━━╮\n┃ ⚠️ 𝑨𝑪𝑪𝑬𝑺𝑺 𝑫𝑬𝑵𝑰𝑬𝑫 ✦\n╰━━━━━━━━━━━━━━━━━━╯\n\nMake bot admin first to use demote`
            });
                return;
            }
        ...
        const demotionMessage = `╭━━━━━━━━━━━━━━━━━━╮\n┃ ⬇️ 𝑫𝑬𝑴𝑶𝑻𝑬𝑫 ✦\n╰━━━━━━━━━━━━━━━━━━╯\n\n` +
            `👤 Demoted: ${usernames.map(name => `${name}`).join(', ')}\n\n` +
            `👑 By: @${message.key.participant ? message.key.participant.split('@')[0] : message.key.remoteJid.split('@')[0]}\n\n` +
